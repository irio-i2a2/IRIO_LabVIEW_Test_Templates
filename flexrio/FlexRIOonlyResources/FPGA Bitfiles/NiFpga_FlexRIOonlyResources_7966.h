 ...
 */
static const char* const NiFpga_FlexRIOonlyResources_7966_Signature = "EE589A2EE1A99EE3D5643336795E11F4";
...
typedef enum
{
   NiFpga_FlexRIOonlyResources_7966_IndicatorU8_DevProfile = 0x322,
...
typedef enum
{
   ...
   NiFpga_FlexRIOonlyResources_7966_IndicatorU32_Fref = 0x328,
...
typedef enum
{
   NiFpga_FlexRIOonlyResources_7966_IndicatorArrayU8_DMATtoHOSTFrameType = 0x316,
   NiFpga_FlexRIOonlyResources_7966_IndicatorArrayU8_DMATtoHOSTSampleSize = 0x31A,
   NiFpga_FlexRIOonlyResources_7966_IndicatorArrayU8_FPGAVIversion = 0x326,
...
typedef enum
{
   NiFpga_FlexRIOonlyResources_7966_IndicatorArrayU16_DMATtoHOSTBlockNWords = 0x31E,
   NiFpga_FlexRIOonlyResources_7966_IndicatorArrayU16_DMATtoHOSTNCh = 0x56,
