 ...
 */
static const char* const NiFpga_FlexRIOnoModule_7966_Signature = "33718404E67DEE14755AE597EB93F80D";
...
typedef enum
{
   NiFpga_FlexRIOnoModule_7966_IndicatorU8_DevProfile = 0xC2,
...
typedef enum
{
   ...
   NiFpga_FlexRIOnoModule_7966_IndicatorU32_Fref = 0xC8,
...
typedef enum
{
   NiFpga_FlexRIOnoModule_7966_IndicatorArrayU8_DMATtoHOSTFrameType = 0xB6,
   NiFpga_FlexRIOnoModule_7966_IndicatorArrayU8_DMATtoHOSTSampleSize = 0xBA,
   NiFpga_FlexRIOnoModule_7966_IndicatorArrayU8_FPGAVIversion = 0xC6,
...
typedef enum
{
   NiFpga_FlexRIOnoModule_7966_IndicatorArrayU16_DMATtoHOSTBlockNWords = 0xBE,
   NiFpga_FlexRIOnoModule_7966_IndicatorArrayU16_DMATtoHOSTNCh = 0x4A,
